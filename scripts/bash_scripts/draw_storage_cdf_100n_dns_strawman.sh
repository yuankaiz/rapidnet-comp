...
inFile="/localdrive1/harshal/calc_prov_storage_strawman/storage_distribution.dat"
outFile="/localdrive1/harshal/calc_prov_storage_strawman/total_storage_cdf_100n.dat"
