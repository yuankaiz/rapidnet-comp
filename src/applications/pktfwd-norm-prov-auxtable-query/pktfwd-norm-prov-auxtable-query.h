...
#ifndef PKTFWDNORMPROVAUXTABLEQUERY_H
#define PKTFWDNORMPROVAUXTABLEQUERY_H
...
class PktfwdNormProvAuxtableQuery : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormProvAuxtableQuery ();

  virtual ~PktfwdNormProvAuxtableQuery ();
...
#endif // PKTFWDNORMPROVAUXTABLEQUERY_H
