...
materialize(recvPacketRef, infinity, infinity, keys(2:cid))./*Reference to the provenance tree*/
...
ro2 recvPacketRef(@Node, PID, EquiHash, PIDev) :-
    recvPacketProv(@Node, SrcAdd, DstAdd, Data, Tag),
...
rho3 recvPacketRef(@Node, PID, EquiHash, PIDev) :-
...
rh04 recvPacket(@Node, SrcAdd, DstAdd, Data) :-
 recvPacketNP(@Node, SrcAdd, DstAdd, Data, PIDHash).
