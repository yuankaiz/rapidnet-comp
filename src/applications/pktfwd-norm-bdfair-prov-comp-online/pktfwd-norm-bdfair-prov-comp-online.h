...
#ifndef PKTFWDNORMBDFAIRPROVCOMPONLINE_H
#define PKTFWDNORMBDFAIRPROVCOMPONLINE_H
...
class PktfwdNormBdfairProvCompOnline : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormBdfairProvCompOnline ();

  virtual ~PktfwdNormBdfairProvCompOnline ();
...
protected:
  ...
  virtual void Prov_rs1_1_eca (Ptr<Tuple> pktProv);
  ...
  virtual void Rs1_eca (Ptr<Tuple> packetP);
  ...
  virtual void Prov_rh2_1_eca (Ptr<Tuple> pktProv);
  ...
  virtual void Rh2_eca (Ptr<Tuple> packetP);
...
#endif // PKTFWDNORMBDFAIRPROVCOMPONLINE_H
