...
using namespace ns3::rapidnet::pktfwdnormbdfairprov;

const string PktfwdNormBdfairProv::DEVICE = "device";
const string PktfwdNormBdfairProv::EPACKET = "epacket";
const string PktfwdNormBdfairProv::EPACKETTEMP = "epacketTemp";
const string PktfwdNormBdfairProv::ERECVPACKET = "erecvPacket";
const string PktfwdNormBdfairProv::ERECVPACKETTEMP = "erecvPacketTemp";
const string PktfwdNormBdfairProv::FLOWENTRY = "flowEntry";
const string PktfwdNormBdfairProv::INITPACKET = "initPacket";
const string PktfwdNormBdfairProv::LINK = "link";
const string PktfwdNormBdfairProv::LINKHR = "linkhr";
const string PktfwdNormBdfairProv::PACKET = "packet";
const string PktfwdNormBdfairProv::PROV = "prov";
const string PktfwdNormBdfairProv::RECVPACKET = "recvPacket";
const string PktfwdNormBdfairProv::RULEEXEC = "ruleExec";

NS_LOG_COMPONENT_DEFINE ("PktfwdNormBdfairProv");
NS_OBJECT_ENSURE_REGISTERED (PktfwdNormBdfairProv);

TypeId
PktfwdNormBdfairProv::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::rapidnet::pktfwdnormbdfairprov::PktfwdNormBdfairProv")
    .SetParent<RapidNetApplicationBase> ()
    .AddConstructor<PktfwdNormBdfairProv> ()
    ;
  return tid;
}

PktfwdNormBdfairProv::PktfwdNormBdfairProv()
{
...
void
PktfwdNormBdfairProv::DoDispose (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
PktfwdNormBdfairProv::StartApplication (void)
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StartApplication ();
  RAPIDNET_LOG_INFO("PktfwdNormBdfairProv Application Started");
}

void
PktfwdNormBdfairProv::StopApplication ()
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StopApplication ();
  RAPIDNET_LOG_INFO("PktfwdNormBdfairProv Application Stopped");
}

void
PktfwdNormBdfairProv::InitDatabase ()
{
...
void
PktfwdNormBdfairProv::DemuxRecv (Ptr<Tuple> tuple)
{
...
void
PktfwdNormBdfairProv::R00Eca1Ins (Ptr<Tuple> initPacket)
{
...
void
PktfwdNormBdfairProv::R01Eca1Ins (Ptr<Tuple> device)
{
...
void
PktfwdNormBdfairProv::R03Eca1Ins (Ptr<Tuple> flowEntry)
{
...
void
PktfwdNormBdfairProv::Prov_rs1_1_eca (Ptr<Tuple> packet)
{
...
void
PktfwdNormBdfairProv::Prov_rs1_2_eca (Ptr<Tuple> epacketTemp)
{
...
void
PktfwdNormBdfairProv::Prov_rs1_3_eca (Ptr<Tuple> epacketTemp)
{
...
void
PktfwdNormBdfairProv::Prov_rs1_4_eca (Ptr<Tuple> epacket)
{
...
void
PktfwdNormBdfairProv::Prov_rs1_5_eca (Ptr<Tuple> epacket)
{
...
void
PktfwdNormBdfairProv::Prov_rh1_1Eca0Ins (Ptr<Tuple> device)
{
...
void
PktfwdNormBdfairProv::Prov_rh1_1Eca1Ins (Ptr<Tuple> initPacket)
{
...
void
PktfwdNormBdfairProv::Prov_rh1_1Eca2Ins (Ptr<Tuple> linkhr)
{
...
void
PktfwdNormBdfairProv::Prov_rh2_1_eca (Ptr<Tuple> packet)
{
...
void
PktfwdNormBdfairProv::Prov_rh2_2_eca (Ptr<Tuple> erecvPacketTemp)
{
...
void
PktfwdNormBdfairProv::Prov_rh2_3_eca (Ptr<Tuple> erecvPacketTemp)
{
...
void
PktfwdNormBdfairProv::Prov_rh2_4_eca (Ptr<Tuple> erecvPacket)
{
...
void
PktfwdNormBdfairProv::Prov_rh2_5_eca (Ptr<Tuple> erecvPacket)
{
