...
const string Myproto::BESTPATH = "bestPath";
const string Myproto::LINK = "link";
const string Myproto::PATH = "path";
const string Myproto::PATHDELETE = "pathDelete";
const string Myproto::R2LOCAL1R2LINKZSEND = "r2Local1r2linkZsend";
const string Myproto::R2LOCAL2PATHSEND = "r2Local2pathsend";
const string Myproto::R2LINKZ = "r2linkZ";
const string Myproto::R2LINKZDELETE = "r2linkZDelete";

NS_LOG_COMPONENT_DEFINE ("Myproto");
NS_OBJECT_ENSURE_REGISTERED (Myproto);

TypeId
Myproto::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::rapidnet::myproto::Myproto")
    .SetParent<RapidNetApplicationBase> ()
    .AddConstructor<Myproto> ()
    ;
  return tid;
}
...
void
Myproto::StartApplication (void)
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StartApplication ();
  RAPIDNET_LOG_INFO("Myproto Application Started");
}

void
Myproto::StopApplication ()
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StopApplication ();
  RAPIDNET_LOG_INFO("Myproto Application Stopped");
}

void
Myproto::InitDatabase ()
{
...
void
Myproto::DemuxRecv (Ptr<Tuple> tuple)
{
...
void
Myproto::R1Eca0Ins (Ptr<Tuple> link)
{
...
void
Myproto::R1Eca0Del (Ptr<Tuple> link)
{
...
void
Myproto::R2Local1Eca0RemoteIns (Ptr<Tuple> r2Local1r2linkZsend)
{
...
void
Myproto::R2Local1Eca0RemoteDel (Ptr<Tuple> r2linkZDelete)
{
...
void
Myproto::R2Local1Eca0Ins (Ptr<Tuple> link)
{
...
void
Myproto::R2Local1Eca0Del (Ptr<Tuple> link)
{
...
void
Myproto::R2Local2Eca0RemoteIns (Ptr<Tuple> r2Local2pathsend)
{
...
void
Myproto::R2Local2Eca0RemoteDel (Ptr<Tuple> pathDelete)
{
...
void
Myproto::R2Local2Eca0Ins (Ptr<Tuple> r2linkZ)
{
...
void
Myproto::R2Local2Eca0Del (Ptr<Tuple> r2linkZ)
{
...
void
Myproto::R2Local2Eca1Ins (Ptr<Tuple> bestPath)
{
...
void
Myproto::R2Local2Eca1Del (Ptr<Tuple> bestPath)
{
