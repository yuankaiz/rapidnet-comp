...
#ifndef PKTFWDNORMPROVRULEAUXTABLE_H
#define PKTFWDNORMPROVRULEAUXTABLE_H
...
class PktfwdNormProvRuleauxtable : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormProvRuleauxtable ();

  virtual ~PktfwdNormProvRuleauxtable ();
...
#endif // PKTFWDNORMPROVRULEAUXTABLE_H
