...
#ifndef PKTFWDNORMPROVEXSPANWITHITMQUERY_H
#define PKTFWDNORMPROVEXSPANWITHITMQUERY_H
...
class PktfwdNormProvExspanWithitmQuery : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormProvExspanWithitmQuery ();

  virtual ~PktfwdNormProvExspanWithitmQuery ();
...
#endif // PKTFWDNORMPROVEXSPANWITHITMQUERY_H
