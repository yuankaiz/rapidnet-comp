...
rs10 eMatchingPacketTemp(@RLoc, Switch, SrcAdd, DstAdd, TopPriority, RID, R, List, HashList) :-
...
rs11 eMatchingPacket(@Switch, SrcAdd, DstAdd, TopPriority, RID, RLoc, HashList) :-
    eMatchingPacketTemp(@RLoc, Switch, SrcAdd, DstAdd, TopPriority, RID, R, List, HashList).
