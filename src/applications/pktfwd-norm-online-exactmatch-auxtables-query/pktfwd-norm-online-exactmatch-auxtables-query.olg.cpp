...
* 
* We add the hash value of the equivalence keys to provLink to
* differentiate provenance trees with the same RID at the same node.
* 
* ProgID is redundant in this program.
*
*****************/
