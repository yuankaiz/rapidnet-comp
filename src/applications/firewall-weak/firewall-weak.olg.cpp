 ...
 * 
 * link(@Switch, Nei, Port):
 *     Switch connects to Nei through Port
 * ------------------------------------------------------------------------------------
 * 
 * One controller
 * multiple switches
 ...
 * Send it to the controller to check if it is trusted
 */
 ...
 *  	by inserting a per flow rule into the switch for that host
 */
