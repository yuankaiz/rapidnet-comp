...
#ifndef PKTFWDNORMPROVCOMPSTRAWMAN_H
#define PKTFWDNORMPROVCOMPSTRAWMAN_H
...
class PktfwdNormProvCompStrawman : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormProvCompStrawman ();

  virtual ~PktfwdNormProvCompStrawman ();
...
#endif // PKTFWDNORMPROVCOMPSTRAWMAN_H
