...
materialize(recvAuxPkt, infinity, infinity, keys(2,3:str)).
...
prov_rh2_3 erecvPacket(@Host, SrcAdd, DstAdd, Data, RID, RLOC, HashList) :-
    erecvPacketTemp(@RLOC, Host, SrcAdd, DstAdd, Data, RID, R, List, HashList).

prov_rh2_4 recvPacket(@Host, SrcAdd, DstAdd, Data, HashList) :-
    erecvPacket(@Host, SrcAdd, DstAdd, Data, RID, RLOC, HashList).

prov_rh2_5 recvAuxPkt(@Host, SrcAdd, Data, HashList) :-
    recvPacket(@Host, SrcAdd, DstAdd, Data, HashList).
