...
#include "ns3/pktfwd-sdn-module.h"
...
void Print ()
{
  PrintRelation (apps, PktfwdSdn::RECVPACKET);
}
...
{
  LogComponentEnable("PktfwdSdn", LOG_LEVEL_INFO);
  LogComponentEnable("RapidNetApplicationBase", LOG_LEVEL_INFO);

  int nodeNum = 6;
  apps = InitRapidNetApps (nodeNum, Create<PktfwdSdnHelper> ());
