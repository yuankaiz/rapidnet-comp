...
#include "ns3/pktfwd-norm-online-exactmatch-auxtables-query-module.h"
#include "ns3/pktfwd-norm-online-query-init-module.h"
#include "ns3/rapidnet-module.h"
#include "ns3/values-module.h"
#include "ns3/helper-module.h"

#define ModuleName PktfwdNormOnlineExactmatchAuxtablesQuery
#define ModuleNameStr "PktfwdNormOnlineExactmatchAuxtablesQuery"
#define ModuleHelper PktfwdNormOnlineExactmatchAuxtablesQueryHelper
#define ModuleNameSpace pktfwdnormonlineexactmatchauxtablesquery
...
void QueryInsertion()
{
  ...
  insert_queryTuple("recvPacket", 3, 1, 3, "hello");
}
...
main (int argc, char *argv[])
{
  ...
  schedule (8.0000, ThirdPacketInsertion);
