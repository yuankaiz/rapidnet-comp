...
#include "ns3/pktfwd-norm-prov-ruleauxtable-query-module.h"
...
#define ModuleName PktfwdNormProvRuleauxtableQuery
#define ModuleNameStr "PktfwdNormProvRuleauxtableQuery"
#define ModuleHelper PktfwdNormProvRuleauxtableQueryHelper
#define ModuleNameSpace pktfwdnormprovruleauxtablequery
