...
#include "ns3/pktfwd-norm-bdfair-prov-comp-online-module.h"
...
#define APP_NAMESPACE PktfwdNormBdfairProvCompOnline
#define HELPER_NAME PktfwdNormBdfairProvCompOnlineHelper
#define USED_NAMESPACE pktfwdnormbdfairprovcomponline
