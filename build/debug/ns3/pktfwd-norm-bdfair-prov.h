...
#ifndef PKTFWDNORMBDFAIRPROV_H
#define PKTFWDNORMBDFAIRPROV_H
...
class PktfwdNormBdfairProv : public RapidNetApplicationBase
{
public:
  ...
  PktfwdNormBdfairProv ();

  virtual ~PktfwdNormBdfairProv ();
